    ...
    <div className="relative">
      ...
      <div className="text-center space-y-6 mb-12">
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <div className="text-left">
            ...
            <p className="text-muted-foreground">
              Gasolineras baratas cerca de ti
            </p>
          </div>
        </div>
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Descubre las gasolineras más baratas o cercanas según tus
          preferencias. Ahorra tiempo y dinero en cada repostaje con datos en
          tiempo real.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
        ...
        <div className="text-center">
          <div className="text-2xl font-bold text-primary">€0.15/l</div>
